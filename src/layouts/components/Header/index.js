...
import { UploadIcon1, UploadIcon2 } from '~/components/icons';
               ...
               <Search />
                ...
                <div className={cx('actions')}>
                    {currentUser ? (
                        <>
                            ...
                            >
                                <button className={cx('action-btn')}>
                                    <UploadIcon2 />
                                    <button className={cx('notification-cout')}>
                                        13
                                    </button>
                                </button>
                            </Tippy>
                    ...
                    >
                        {currentUser ? (
                            <Image
                                src="https://i.pinimg.com/564x/2b/0f/7a/2b0f7a9533237b7e9b49f62ba73b95dc.jpg"
